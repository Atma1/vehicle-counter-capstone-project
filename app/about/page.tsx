    ...
    <div className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {teamMembers.map((member, index) => (
            <div key={index} className="card text-center p-4 shadow-lg rounded-lg transition-transform transform hover:scale-95">
              <Image src={member.photo} alt={member.name} width={128} height={128} className="w-32 h-32 mx-auto rounded-full mb-4" />
        ...
        <div className="flex justify-center space-x-20">
          ...
          <Image src="/assets/nextjs.png" alt="Nextjs" width={60} height={60} />
        </div>
      </div>
    </div>
  );
